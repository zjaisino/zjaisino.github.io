var Tools = {
    ...
    convert:function(val){
        return parseInt(val*255).toString(16);
    }
}
...
var zen_settings = {
    ...
    'css': {
        'snippets': {
            'time': Tools.echoDate(),
            'css': '/**\n * @filename ${val}.css\n * @author Aniu['+Tools.echoDate()+']\n * @update Aniu['+Tools.echoDate()+']\n * @version v1.1\n * @description none\n */',
            '@i': '@import url(|);',
            '@m': '@media print {\n\t|\n}',
            '@f': '@font-face {\n\tfont-family:|;\n\tsrc:url(|);\n}',
            'hack:webkit': '@media screen and(-webkit-min-device-pixel-ratio:0){|}',
            'hack:w': '@media screen and(-webkit-min-device-pixel-ratio:0){|}',
            'hack:op': '@media all and(-webkit-min-device-pixel-ratio:10000),not all and(-webkit-min-device-pixel-ratio:0){|}',
            'hack:o': '@media all and(-webkit-min-device-pixel-ratio:10000),not all and(-webkit-min-device-pixel-ratio:0){|}',
            'hack:moz': '@-moz-document url-prefix(){|}',
            'hack:m': '@-moz-document url-prefix(){|}',
            'hack:phone': '@media screen and(max-device-width:480px){|}',
            'hack:p': '@media screen and(max-device-width:480px){|}',
            'hack:ie6': '*html',
            'hack:ie7': '*+html',
            'note': '/* | */',
			'fixed': 'position:fixed; _position:absolute; right:10px; bottom:10px; _top:expression(eval(document.documentElement.scrollTop+document.documentElement.clientHeight-this.offsetHeight-(parseInt(this.currentStyle.marginTop,10)||10)-(parseInt(this.currentStyle.marginBottom,10)||0)));',
            'pngfix': '_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'|\'); _background:none;',
            'gray': '-webkit-filter:grayscale(1); -ms-filter:grayscale(1); filter:grayscale(1); filter:progid:DXImageTransform.Microsoft.BasicImage(grayscale=1);',
            'tran': 'filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#${convert}000000,endColorstr=#${convert}000000); background:rgba(0,0,0,${val}); background:transparent\\;',
            'tine': 'display:inline-block; line-height:0; font-size:0; border:6px dashed transparent; border-top-color:#ccc; border-top-style:solid;',
            'tine:dir': 'border:6px dashed transparent; border-${val}-color:#ccc; border-${val}-style:solid;',
            'about:blank': '_background-image:url(about:blank); _background-attachment:fixed;',
            'auto': '@media screen and (min-width:|px) and (max-width:1200px){}',
            'auto:min': '@media screen and (min-width:|px){}',
            'auto:max': '@media screen and (max-width:|px){}',
            'min:h': 'min-height:${val}px; _height:expression(this.scrollHeight < ${val} ? \'${val}px\' : \'auto\');',
            'min:w': 'min-width:${val}px; _width:expression(document.body.clientWidth < ${val} ? \'${val}px\' : \'auto\');',
            'max:h': 'max-height:${val}px; _height:expression(this.scrollHeight > ${val} ? \'${val}px\' : \'auto\');',
            'max:w': 'max-width:${val}px; _width:expression(document.body.clientWidth > ${val} ? \'${val}px\' : \'auto\');',
            'op': 'opacity:|; filter:alpha(opacity=100);',
            'op:ie': 'filter:alpha(opacity=100);',
            ...
            "op": "opacity:|;",
            "opacity:ie": "filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=100);",
            ...
            "orp": "orphans:|;",
            "wid": "widows:|;",
			"animate": "animation:name duration timing-function[linear,ease,ease-in,ease-out,ease-in-out] delay iteration-count[n,infinite] direction[normal,alternate]",
			"ani": "-webkit-animation:${val} 1s linear 0s infinite; animation:${val} 1s linear 0s infinite;"
        }
    },
    ...
    'js': {
        'snippets': {
            ...
            'note' : '/**\n * @func \n * @type <>\n * @return <>\n * @param param <>\n * @desc \n */',
            'jq' : '${jq}(function(){\n\t|\n});',
            'jq:ready' : '${jq}(document).ready(function(){\n\t|\n});',
            'jq:fn' : '${jq}.fn.method = function(o){\n\to = ${jq}.extend({}, o${or}{});\n\treturn this.each(function(){\n\t\t|\n\t});\n}',
            'jq:fn' : '${jq}.fn.${val} = function(o){\n\to = ${jq}.extend({}, o${or}{});\n\treturn this.each(function(){\n\t\t|\n\t});\n}'
        }
    },
    ...
    'html': {
        ...
        'snippets': {
            ...
            'html:app': '<!DOCTYPE html>\n' +
                    ...
                    '\t<title></title>\n' +
                    '\t<link rel="stylesheet" type="text/css" href="./static/style/api.css" />\n' +
        ...
        'abbreviations': {
            'a': '<a href="#" title=""></a>',
            'a:r': '<a href="<@a.rwrite value="" />"></a>',
            'a:link': '<a href="http://|" title=""></a>',
            'a:mail': '<a href="mailto:|" title=""></a>',
            'a:tel': '<a href="tel:|" title=""></a>',
            ...
            'div:id': '<div id="|"></div>',
            'em': '<em>|</em>',
            'link': '<link rel="stylesheet" type="text/css" href="|" media="screen" />',
            'link:loc': '<link rel="stylesheet" type="text/css" href="file:///E:/User/static/base.css" />',
            'link:l': '<link rel="stylesheet" type="text/css" href="file:///E:/User/static/base.css" />',
            'link:css': '<link rel="stylesheet" type="text/css" href="|" />',
            'link:c': '<link rel="stylesheet" type="text/css" href="|" />',
            'link:base': '<link rel="stylesheet" type="text/css" href="|base.css" />',
            'link:page': '<link rel="stylesheet" type="text/css" href="|page.css" />',
            'link:print': '<link rel="stylesheet" type="text/css" href="|" media="print" />',
            'link:p': '<link rel="stylesheet" type="text/css" href="|" media="print" />',
            'link:icon': '<link rel="shortcut icon" type="image/x-icon" href="|favicon.ico" />',
            'link:f': '<link rel="shortcut icon" type="image/x-icon" href="|favicon.ico" />',
            'link:touch': '<link rel="apple-touch-icon" href="|favicon.png" />',
            'link:t': '<link rel="apple-touch-icon" href="|favicon.png" />',
            'link:rss': '<link rel="alternate" type="application/rss+xml" title="RSS" href="|rss.xml" />',
            'link:r': '<link rel="alternate" type="application/rss+xml" title="RSS" href="|rss.xml" />',
            'link:atom': '<link rel="alternate" type="application/atom+xml" title="Atom" href="atom.xml" />',
            'link:a': '<link rel="alternate" type="application/atom+xml" title="Atom" href="atom.xml" />',
            'meta:charset': '<meta charset="utf-8" />',
            'meta:c': '<meta charset="utf-8" />',
            'meta:utf': '<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />',
            'meta:u': '<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />',
            ...
            'meta:a': '<meta name="author" content="|" />',
            'meta:revised': '<meta name="revised" content="|" />',
            'meta:r': '<meta name="revised" content="|" />',
            'meta:win': '<meta http-equiv="Content-Type" content="text/html;charset=windows-1251" />',
            'meta:compat': '<meta http-equiv="X-UA-Compatible" content="IE=7" />',
            'style': '<style type="text/css">\n|\n</style>',
            'script': '<script type="text/javascript">\n|\n</script>',
            'script:loc': '<script type="text/javascript" src="file:///E:/User/static/jquery.js"></script>',
            'script:l': '<script type="text/javascript" src="file:///E:/User/static/jquery.js"></script>',
            'script:template': '<script id="" type="text/html">\n|\n</script>',
            'script:t': '<script id="" type="text/html">\n|\n</script>',
            'script:src': '<script type="text/javascript" src="|"></script>',
            'script:s': '<script type="text/javascript" src="|"></script>',
            'script:jq': '<script type="text/javascript" src="|jquery.js"></script>',
            'script:jq1-4': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js" type="text/javascript"></script> ',
            'script:jq1-5': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js" type="text/javascript"></script> ',
            'script:jq1-6': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js" type="text/javascript"></script> ',
            'script:jq1-7': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js" type="text/javascript"></script> ',
            'script:jq1-8': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js" type="text/javascript"></script> ',
            'script:jq1-9': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js" type="text/javascript"></script> ',
            'script:jq2-0': '<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.1/jquery.min.js" type="text/javascript"></script> ',
            'strong': '<strong>|</strong>',
            'span': '<span>|</span>',
            'icon': '<i class="ui-icon"></i>',
            'tine': '<i class="ui-tine"></i>',
            ...
            'input:text': '<input type="text" name="" autocomplete="off" id="" />',
            'input:t': '<input type="text" name="" autocomplete="off" id="" />',
            'input:search' : '<input type="text" name="" id="" x-webkit-speech="true" x-webkit-grammar="builtin:search" accesskey="s" autocomplete="off" />',
            'input:sc': '<input type="search" name="" id="" />',
            ...
            'ol+': 'ol>li',
            'ul+': 'ul>li',
            'nav+': 'div.m-nav>ul.m-navlist>li*6>a',
            'dl+': 'dl>dt+dd',
            'map+': 'map>area',
            'table+': 'table>tr>td',
        ...
        'element_types': {
            'empty': 'area,base,basefont,br,col,frame,h r,img,input,isindex,link,meta,param,embed,keygen,command',
...
//              re = /([\+>])?([a-z@\!][a-z0-9:\-]*)(#[\w\-\$]+)?((?:\.[\w\-\$]+)*)(\*(\d*))?(\+$)?/ig;
    ...
    return {
         ...
         *分割缩写值,获取第3个值
         */
        splitVal : function(abbr){
            var val = abbr.split(':'), _retutn = false;
            val = val[1] ? val[1].split('_') : '';
            if(val[1])
            {
                zen_settings.variables.val = abbr.substring(abbr.indexOf('_')+1, abbr.length);
                zen_settings.variables.convert = Tools.convert(zen_settings.variables.val);
                _retutn = !val[0] ? abbr.substring(0, abbr.lastIndexOf(':')) : abbr.substring(0, abbr.indexOf('_'));
            }
            return _retutn;
        },
        ...
        expandAbbreviation: function(abbr, type, profile) {
            type = type || 'html';
            (this.splitVal(abbr) !== false) && (abbr = this.splitVal(abbr));
...
/**
 * Simple JS commenting
 * @param {zen_editor} editor
 * @return {Boolean} Returns <code>true</code> if comment was toggled
 */
function toggleJSComment(editor) {
    var rng = editor.getSelectionRange();
...
//              caret_pos += lines.length - 1;
        ...
        getSyntax: function() {
            ...
            if (syntax == 'html') {
                ...
                if (pair && pair[0] && pair[0].type == 'tag' && pair[0].name.toLowerCase() == 'script') {
                    // check that we're actually inside the tag
                    if (pair[0].end <= caret_pos && pair[1].start >= caret_pos)
                        syntax = 'js';
                }
